...
from route_graph_webui.backend.services.job_service import (
    BackgroundJobRecord as AutoPlanJobRecord,
    BackgroundJobService,
    serialize_job_status,
)
from route_graph_webui.backend.services.mission_service import (
    build_mission_preview,
    export_candidate_missions,
)
from route_graph_webui.backend.services.planning_service import (
    generate_auto_candidate_set,
    generate_manual_candidate_set,
)
from route_graph_webui.graph.canvas_view import sync_graph_gui_canvas_view
...
from route_graph_webui.planning.route_planner import RoutePlanningError
...
AUTO_PLAN_WORKER_MODULE = "route_graph_webui.apps.workers.route_generation"
AUTO_PLAN_WORKER_PATH = Path(route_generation_worker_module.__file__).resolve()
...
auto_plan_job_service = BackgroundJobService(
    ...
    worker_module=AUTO_PLAN_WORKER_MODULE,
...
async def create_auto_plan_job(request: GenerateAutoPlanRequest) -> dict[str, Any]:
    try:
        ...
        auto_plan_job_service.worker_module = AUTO_PLAN_WORKER_MODULE
        auto_plan_job_service.runtime_root = PROGRESS_ROOT
