...
from route_graph_webui.storage.json_store import consume_jsonl_text, read_json_mapping_if_ready, write_json_atomic
    ...
    try:
        ...
        with stderr_path.open("w", encoding="utf-8") as stderr_handle:
            worker_command = (
                ...
                if worker_module
                else [python_executable or sys.executable, str(worker_path)]
            )
...
class BackgroundJobService:
    ...
    def create_worker_job(
        ...
        *,
        ...
        if self.worker_module is None and not self.worker_path.exists():
