...
from env_registry import extract_env_name
from graph_schema import GraphSchemaError
from mission_io import load_mission_json, write_mission_json
from runtime import timestamp_now
from spelling_compat import (
    CANONICAL_PHOTOS_DIR_NAME,
    LEGACY_PHOTOS_DIR_NAME,
    resolve_photos_root,
)
from tools.mission.mission_repair import merge_repair_images, repair_mission_payload


THIS_DIR = ROUTE_GRAPH_WEBUI_DIR
PROJECT_ROOT = ROUTE_GRAPH_WEBUI_DIR.parent
...
def _resolve_default_photos_root(missions_root: Path) -> Path:
    ...
    data_root = THIS_DIR / "data" / "data_photos_videos"
