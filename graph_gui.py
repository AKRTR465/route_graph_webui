...
if __package__ in {None, ""}:
    ...
    from auto_route_planner import AutoPlanningConfig, AutoPlanningExportConfig
    from graph_canvas_view import (
    ...
    from edge_intent_service import resolve_edge_creation_intent
    ...
    from runtime import resolve_data_path, timestamp_now
    from webui_backend.services.job_service import BackgroundJobRecord, BackgroundJobService
...
def launch_gui(args: argparse.Namespace) -> int:
    ...
    class GraphGuiApp:
        def __init__(self, root: tk.Tk) -> None:
            ...
            self._route_generation_worker_path = Path(__file__).resolve().with_name(
            ...
            self._route_generation_job_service = BackgroundJobService(
                ...
                project_root=self._route_generation_worker_path.parent,
